...
var ASM_CONSTS = {
  4557624: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4557679: ($0) => { performance.now = function() { return $0; }; },  
 4557727: ($0) => { performance.now = function() { return $0; }; },  
 4557775: () => { performance.now = Module['emscripten_get_now_backup']; }
};
