...
var ASM_CONSTS = {
  4558344: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4558399: ($0) => { performance.now = function() { return $0; }; },  
 4558447: ($0) => { performance.now = function() { return $0; }; },  
 4558495: () => { performance.now = Module['emscripten_get_now_backup']; }
};
