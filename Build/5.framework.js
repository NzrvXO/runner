...
var ASM_CONSTS = {
  4567272: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4567327: ($0) => { performance.now = function() { return $0; }; },  
 4567375: ($0) => { performance.now = function() { return $0; }; },  
 4567423: () => { performance.now = Module['emscripten_get_now_backup']; }
};
