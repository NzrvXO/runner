...
var ASM_CONSTS = {
  4536656: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4536711: ($0) => { performance.now = function() { return $0; }; },  
 4536759: ($0) => { performance.now = function() { return $0; }; },  
 4536807: () => { performance.now = Module['emscripten_get_now_backup']; }
};
